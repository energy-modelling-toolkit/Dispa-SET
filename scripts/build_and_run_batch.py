...
all_combinations = product(heat_demand_scen, power_scen, cost_heat_slack_scen, res_mod_scen)
logging.info('{} runs will be made'.format(len(list(all_combinations))))  # 36 for this case
i = 0

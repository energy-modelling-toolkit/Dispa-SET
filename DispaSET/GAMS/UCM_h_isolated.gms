...
CostVariableB(u,h)               [EUR\MW]   Alternative Variable costs (e.g. fuel prices)
...
Power(u,h)                 [MW]    Total power output for each power unit
*******
...
EQ_SystemCost(n,i)..
         ...
         +sum((u,nn)$(Location(u,n) EQ 1 and ord(n) ne ord(nn)),CostVariableB(u,i) * PowerN(u,nn,i))
...
$If %Verbose% == 1   Display TimeUpLeft_initial,TimeUpLeft_JustStarted,TimeDownLeft_initial,TimeDownLeft_JustStopped,TimeUpInitial,TimeDownInitial,PowerInitial,CommittedInitial;
...
TotalNodeOperationCost2(n,h)
NetNodeOperationCost(n,h)
...
UnitVariableCost(u,n,z)$(Location(u,n) EQ 1)= CostVariable(u,z) * PowerN.L(u,n,z)
                                            + sum(nn$(Location(u,nn) EQ 0),CostVariableB(u,z) * PowerN.L(u,nn,z));
...
TotalImportedPowerCost(n,z)= sum(u$(Location(u,n) EQ 0),PowerN.L(u,n,z)*CostVariableB(u,z));
ImportedPowerFromNode(n,nn,z)= sum(u$(Location(u,nn) EQ 1 and Location(u,n) EQ 0),PowerN.L(u,n,z));
ImportedPowerFromNodeCost(n,nn,z)= sum(u$(Location(u,nn) EQ 1 and Location(u,n) EQ 0),PowerN.L(u,n,z)*CostVariableB(u,z));

TotalExportedPower(n,z)= sum(u$(Location(u,n) EQ 1),Power.L(u,z)-PowerN.L(u,n,z));
TotalExportedPowerCost(n,z)= sum(u$(Location(u,n) EQ 1),(Power.L(u,z)-PowerN.L(u,n,z))*CostVariableB(u,z));
ExportedPowerToNode(n,nn,z)= sum(u$(Location(u,n) EQ 1 and Location(u,nn) EQ 0),PowerN.L(u,nn,z));
ExportedPowerToNodeCost(n,nn,z)= sum(u$(Location(u,n) EQ 1 and Location(u,nn) EQ 0),PowerN.L(u,nn,z)*CostVariableB(u,z));

TotalNodeOperationCost2(n,z)= sum(u$(Location(u,n) EQ 1), PowerN.L(u,n,z)*CostVariable(u,z))
                            + sum(u$(Location(u,n) EQ 0),PowerN.L(u,n,z)*CostVariableB(u,z));

NetNodeOperationCost(n,z)= sum(u$(Location(u,n) EQ 1), PowerN.L(u,n,z)*CostVariable(u,z))
                            + sum(u$(Location(u,n) EQ 0),PowerN.L(u,n,z)*CostVariableB(u,z))
                            - sum(u$(Location(u,n) EQ 1),(Power.L(u,z)-PowerN.L(u,n,z))*CostVariableB(u,z));
...
NodeExportValue(n,z) = sum(u$(Location(u,n) EQ 1),(Power.L(u,z)-PowerN.L(u,n,z))*CostVariableB(u,z));
NodeExportValue2(n,z) = sum((u,nn)$(Location(u,n) EQ 1 and Location(u,nn) EQ 0),PowerN.L(u,nn,z)*CostVariableB(u,z));
NodeImportValue(n,z) = sum(u$(Location(u,n) EQ 0),PowerN.L(u,n,z)*CostVariableB(u,z));
...
NodeFuelCost(n,f,z)=sum(u$(Fuel(u,f) EQ 1 and Location(u,n) EQ 1),PowerN.L(u,n,z)*CostVariable(u,z))
                    + sum((u,nn)$(Fuel(u,f) EQ 1 and Location(u,n) EQ 1 and Location(u,nn) EQ 0),PowerN.L(u,nn,z)*CostVariableB(u,z));
